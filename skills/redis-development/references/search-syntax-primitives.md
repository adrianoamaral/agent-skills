...
This reference is the canonical vocabulary for the Redis Search query DSL. Action-oriented rules (`search-query-syntax.md`, `search-vector-query.md`, `search-aggregate-pipeline.md`, etc.) link here by anchor instead of redefining terms — read this once to anchor terminology, then use the rules for "how to do X."
...
- Operator-by-operator with escaping rules: [`rules/search-query-syntax.md`](../rules/search-query-syntax.md)
- Vector-query attribute form: [`rules/search-vector-query.md`](../rules/search-vector-query.md)
- Aggregate pipeline stages: [`rules/search-aggregate-pipeline.md`](../rules/search-aggregate-pipeline.md)
- Tokenization, stemming, stopwords: [`rules/search-text-tokenization.md`](../rules/search-text-tokenization.md)
- Result shaping (`RETURN`, `SORTBY`, `HIGHLIGHT`, `SUMMARIZE`): [`rules/search-result-shaping.md`](../rules/search-result-shaping.md)
