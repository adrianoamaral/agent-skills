---
title: Run KNN, Range, and Pre-Filtered Vector Queries
impact: HIGH
impactDescription: Correct vector-query syntax avoids full-scan fallbacks and lets pre-filters cut search space 10–100x
tags: search, vector, knn, range, hybrid, pre-filter, params, ef-runtime
description: Run KNN, Range, and Pre-Filtered Vector Queries
alwaysApply: true
---
