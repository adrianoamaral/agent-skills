---
title: Control Tokenization with NOSTEM, LANGUAGE, STOPWORDS, PHONETIC
impact: MEDIUM
impactDescription: Tokenization choices determine recall — wrong stemmer or stopword set silently drops correct matches
tags: search, tokenization, stemming, nostem, language, stopwords, phonetic, weight
description: Control Tokenization with NOSTEM, LANGUAGE, STOPWORDS, PHONETIC
alwaysApply: true
---
