---
title: Tune FT.CREATE Options for Memory and Indexing Cost
impact: LOW
impactDescription: Disabling unused index features can cut memory 20–50% on large indexes
tags: search, ft.create, skipinitialscan, noffsets, nohl, nofields, nofreqs, maxtextfields, stopwords, temporary
description: Tune FT.CREATE Options for Memory and Indexing Cost
alwaysApply: true
---
...
### Don't use `SKIPINITIALSCAN` when
