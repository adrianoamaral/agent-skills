...
impact: HIGH
impactDescription: HNSW gives ~95%+ recall at sub-millisecond latency; FLAT gives exact results but scales linearly
tags: vector, hnsw, flat, algorithm, performance, ef-construction, ef-runtime
