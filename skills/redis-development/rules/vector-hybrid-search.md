---
title: Combine Lexical and Vector Search Correctly
impact: MEDIUM
impactDescription: Pre-filter + KNN works on every Redis 8.x; FT.HYBRID adds explicit rank fusion on Redis ≥ 8.4.0
tags: vector, hybrid, filters, pre-filter, ft.hybrid, knn, rrf, search
description: Combine Lexical and Vector Search Correctly
alwaysApply: true
---
