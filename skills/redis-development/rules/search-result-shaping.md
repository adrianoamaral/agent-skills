---
title: Shape Search Results with RETURN, SORTBY, HIGHLIGHT, SUMMARIZE
impact: MEDIUM
impactDescription: Returning only needed fields and using SORTABLE cuts payload + latency by 2–10x
tags: search, return, nocontent, limit, sortby, highlight, summarize, pagination
description: Shape Search Results with RETURN, SORTBY, HIGHLIGHT, SUMMARIZE
alwaysApply: true
---
