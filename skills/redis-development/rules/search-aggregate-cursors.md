---
title: Paginate Large Aggregations with FT.CURSOR
impact: MEDIUM
impactDescription: Cursors stream million-row aggregates without blowing memory; releasing them avoids server-side leaks
tags: search, ft.aggregate, ft.cursor, withcursor, pagination, streaming
description: Paginate Large Aggregations with FT.CURSOR
alwaysApply: true
---
