---
title: Debug Queries with FT.EXPLAIN, FT.PROFILE, FT.INFO
impact: MEDIUM
impactDescription: Targeted diagnostics turn "empty results" or "slow query" guesses into 10-second answers
tags: search, ft.explain, ft.profile, ft.info, debugging, troubleshooting
description: Debug Queries with FT.EXPLAIN, FT.PROFILE, FT.INFO
alwaysApply: true
---
