---
title: Write Performant Queries
impact: HIGH
impactDescription: Pre-filters, SORTABLE fields, and tight RETURN cut query latency by orders of magnitude
tags: search, ft.search, performance, filters, sortby, limit, return, profile
description: Write Performant Queries
alwaysApply: true
---
